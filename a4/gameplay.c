...
/* Return 1 if guess if this guess lead to win, check if it in the word, change guess left
,change guessed character.
 */
int guess_done(struct game_state *game, char guess){
	int have = 0;
	for (int i = 0; i < 26; i++){
		if((char)('a' + i) == guess){
